...
export const workspace: WorkspaceData = {
  ...
  transactions: [
    ...
    { id: "txn-003", reference: "MBM-2403", businessId: "business-grocery", businessUnitId: "unit-yaounde-shop", customerName: "Walk-in customer", itemCount: 4, amount: 12200, paymentMethod: "cash", status: "queued", createdAt: "2026-06-10T10:10:00Z", recordedBy: "Clarisse Mballa" },
